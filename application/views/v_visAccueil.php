<div id="contenu">
	...
	<p>Bienvenue dans votre application de gestion des frais de déplacements. </p>
		...
		<ul>
			...
			<li>Vous complétez les fiches de frais Ã  votre rythme;</li>
			<li>Lorsqu'une fiche est totalement renseignée, vous devrez la "signer" afin qu'elle puisse Ãªtre traitée par le service comptable;</li>
		</ul>



		Au moyen du bandeau gauche, vous avez accÃ¨s aux fonctionalités 
		du profil visiteur : 
		<ul>
